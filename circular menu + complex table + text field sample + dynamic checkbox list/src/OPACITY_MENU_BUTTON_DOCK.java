...
public class OPACITY_MENU_BUTTON_DOCK extends UNICODE_MenuPanel
{
    ...
    { 
        ...
        if ( getMenu ( ).getButtonList ( ).get ( LAST_BUTTON - 1 ).contains ( mEvent.getX ( ), mEvent.getY ( ) ) )
        {
            ...
            guiPanel.opacityManager.incOpacLevel ( ); 
            guiPanel.applicationFrame.setOpacity ( guiPanel.opacityManager.getOpacLevel ( ) );
            guiPanel.applicationFrame.repaint ( );
        }
        ...
        if ( getMenu ( ).getButtonList ( ).get ( LAST_BUTTON - 2 ).contains ( mEvent.getX ( ), mEvent.getY ( ) ) )
        {
            ...
            guiPanel.opacityManager.decOpacLevel ( ); 
            guiPanel.applicationFrame.setOpacity ( guiPanel.opacityManager.getOpacLevel ( ) );
            guiPanel.applicationFrame.repaint ( );
        }
