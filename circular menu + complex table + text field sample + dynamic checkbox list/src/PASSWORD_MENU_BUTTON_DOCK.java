...
public class PASSWORD_MENU_BUTTON_DOCK extends UNICODE_MenuPanel
{
    ...
    public void drawMore ( )
    {
        ...
        guiPanel.entranceFields [ 0 ].draw ( GRAPHICS_COMPONENT, GRAPHICS2D_COMPONENT, guiPanel.font, "AristotlePunk.ttf", "AngelicWar.ttf", 80.0f, Color.gray, 30.0f, Color.white, "yes", 0, 0, 25.0f, ".", 20, Color.white );
        guiPanel.entranceFields [ 1 ].draw ( GRAPHICS_COMPONENT, GRAPHICS2D_COMPONENT, guiPanel.font, "AristotlePunk.ttf", "AngelicWar.ttf", 120.0f, Color.gray, 30.0f, Color.white, "yes", 0, 80, 25.0f, ".", 20, Color.white );
    }
}  