...
public class UNICODE_ConfigurationManager
{
    ...
    //getConnectionUsername from file
    public String getConnectionUsernameFromFile ( )
    {
        String value = null;
    ...
    public String getConnectionPasswordFromFile ( )
    {
        String value = null;
    ...
    public String getConnectionUrlFromFile ( )
    {
        String value = null;
